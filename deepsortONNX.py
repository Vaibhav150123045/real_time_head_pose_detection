...
class YoloDetector:
    ...
    def __init__(self, model_name):
        self.model = onnx.load('yolov8n.onnx')
        self.model_props = {p.key: p.value for p in self.model.metadata_props}
        self.classes = ast.literal_eval(self.model_props['names'])
        print(self.classes)
